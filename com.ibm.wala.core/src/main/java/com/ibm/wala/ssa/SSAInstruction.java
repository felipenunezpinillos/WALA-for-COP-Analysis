...
import com.ibm.wala.ssa.SSAContextAdaptInstruction;
import com.ibm.wala.ssa.SSAContextActivateInstruction;
...
public abstract class SSAInstruction {
  ...
  */
  ...
  public void visit(IVisitor v) {
      if (this instanceof SSAContextAdaptInstruction) {
          v.visitContextAdapt((SSAContextAdaptInstruction) this);
      } else if (this instanceof SSAContextActivateInstruction) {
          v.visitContextActivate((SSAContextActivateInstruction) this);
      } else {
          // Default processing for other instructions
          v.visitInvoke((SSAInvokeInstruction) this);
      }
  }
  ...
  public static interface IVisitor {
    ...
    // Adapt and Activate
    default void visitContextAdapt(SSAContextAdaptInstruction instruction) {}

    default void visitContextActivate(SSAContextActivateInstruction instruction) {}
  ...
  public abstract static class Visitor implements IVisitor {
    ...
    // COP, adapt and Activate
    
    @Override
    public void visitContextAdapt(SSAContextAdaptInstruction instruction) {
        // Default behavior for context adaptation instruction
        System.out.println("Visiting Context Adapt Instruction: " + instruction);
    }

    @Override
    public void visitContextActivate(SSAContextActivateInstruction instruction) {
        // Default behavior for context activation instruction
        System.out.println("Visiting Context Activate Instruction: " + instruction);
    }
